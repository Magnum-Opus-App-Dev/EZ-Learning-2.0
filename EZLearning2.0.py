...
class PROFILE_SETTINGS():
    def __init__(self, master):
        ...
        self.user_icon_dark = ImageTk.PhotoImage(Image.open("images/defaultprofile_dark.png"))
        self.user_icon_light = ImageTk.PhotoImage(Image.open("images/defaultprofile_light.png"))
