...
class LOGIN(customtkinter.CTk):
    def __init__(self, master):
        ...
        self.sub = Label(self.master, text='IT 105 - Application Development and Emerging Technologies', justify=LEFT,
                         font=('Arial', 7, 'bold'), bg='#121212', fg="#bbbbbb")
        ...
        self.dev_names = Label(self.master,
                               ...
                               justify=LEFT, font=('Roboto', 7), bg='#121212', fg="#bbbbbb")
    ...
    def change_appearance_mode(self, new_appearance_mode):
        ...
        if new_appearance_mode == "Dark":
            ...
            self.canvas = Label(self.master, image=self.photoimage, bd=0)
            self.canvas.place(x=410, y=15)
            self.sub = Label(self.master, text='IT 105 - Application Development and Emerging Technologies',
                             justify=LEFT, font=('Arial', 7, 'bold'), bg='#121212', fg="#bbbbbb")
            self.sub.place(x=10, y=474)
            self.dev_names = Label(self.master,
                                   text='Dar, John Homer Sayno\nDela Fuente, Ar-Jay\nEchano, Angelo Millares\nMalubay, Arriana Mae Vargas\nMortiga, Renze Meinard',
                                   justify=LEFT, font=('Roboto', 7), bg='#121212', fg="#bbbbbb")
            ...
            self.canvas.place(x=410, y=15)
            self.sub = Label(self.master, text='IT 105 - Application Development and Emerging Technologies',
                             justify=LEFT, font=('Arial', 7, 'bold'), bg='#0d9187', fg="#2e2e2e")
            self.sub.place(x=10, y=474)
            self.dev_names = Label(self.master,
                                   text='Dar, John Homer Sayno\nDela Fuente, Ar-Jay\nEchano, Angelo Millares\nMalubay, Arriana Mae Vargas\nMortiga, Renze Meinard',
                                   justify=LEFT, font=('Roboto', 7), bg='#0d9187', fg="#2e2e2e")
            self.dev_names.place(x=10, y=418)

    def login(self):
        if self._Email.get() == '' or self._Password.get() == '':
            tkinter.messagebox.showinfo('Try Again', 'Please complete the required fields.')
        else:
            try:
...
class NOTES_FOLDER(customtkinter.CTk):
    ...
    def content_features(self, search_img, content_img, folder_img, menu_img, quiz_a_fg, quiz_a_bg, notes_fg, notes_bg,
                         btn_img, side_btn):
    ...
    def features(self):
        ...
        if self.bg_color == "#121212":
            self.content_features(self.search_dark, self.contentbg_dark, self.folder_dark, self.threelinemenu_dark,
                                  self.bg_color, "#A6A6A6", "#F2F2F2", "#2C2C2C", self.addbtn_dark,
                                  self.sidebutton_dark)

        elif self.bg_color == "#0d9187":
            self.content_features(self.search_light, self.contentbg_light, self.folder_light, self.threelinemenu_light,
                                  "#F2F2F2", "#0c325c", "#0c325c", "#12c8bb", self.addbtn_light, self.sidebutton_light)
...
class NOTE_FILES(customtkinter.CTk):
    ...
    def features(self):
        ...
        if self.bg_color == "#121212":
            self.content_features(self.search_dark, self.threelinemenu_dark, self.contentbg_dark, self.sidebutton_dark,
                                  "#F2F2F2", "#2C2C2C", self.indivfile_dark)
        elif self.bg_color == "#0d9187":
    ...
    def features(self):
        ...
        if self.bg_color == "#121212":
            ...
            self.content_features(self.search_dark, self.contentbg_dark, self.threelinemenu_dark,
                                  self.bg_color, "#A6A6A6", "#F2F2F2", "#2C2C2C", self.sidebutton_dark,
                                  self.addbtn_dark)
